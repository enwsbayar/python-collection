...
class Ship:
    ...
    def is_worth_it(self):
        # Calculate the actual cargo weight by removing crew weight
        # Each crew member adds 1.5 units to the draft
        cargo_weight = self.draft - (self.crew * 1.5)
        return cargo_weight > 20